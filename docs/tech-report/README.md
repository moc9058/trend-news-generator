...
| [05-detailed-design/10-research-agent.md](05-detailed-design/10-research-agent.md) | 資料調査エージェント(Research Agent)+ short/article/report 移行(**状態: 実装済み・未デプロイ**) | レポート生成機能の設計・実装を確認したい |
