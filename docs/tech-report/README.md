...
| [03-data-model.md](03-data-model.md) | Firestore 全コレクションのスキーマ・ID 規約・状態遷移 | データの形と流れを知りたい(全文書の参照先) |
...
| [05-detailed-design/03-generate.md](05-detailed-design/03-generate.md) | ②生成(短文 / 記事の2段階長文。レポートは doc 10) | LLM で文章を作る仕組み |
...
| [05-detailed-design/10-research-agent.md](05-detailed-design/10-research-agent.md) | 資料調査エージェント(Research Agent)+ short/article/report 移行(**状態: 実装済み・デプロイ済み。2026-07-15 に実行基盤を自前 Harness → LangGraph へ移行**) | レポート生成機能の設計・実装を確認したい |
| [05-detailed-design/11-research-chat.md](05-detailed-design/11-research-chat.md) | リサーチチャット(壁打ち / 調査の2モード、SSE、作成フローへの引き継ぎ) | 管理画面のチャット機能の設計・実装を確認したい |
...
| フォーマット(format) | 成果物区分 `short`(旧 daily)/ `article`(旧 weekly)/ `report`(旧 monthly) | 頻度・粒度 |
...
| `pipeline/app/chat/**`、`pipeline/app/repo/chat.py` | [05/11-research-chat](05-detailed-design/11-research-chat.md)(スキーマに影響すれば [03-data-model](03-data-model.md) も) |
| `pipeline/app/research/**` | [05/10-research-agent](05-detailed-design/10-research-agent.md)(チャットからの seed 注入は [05/11-research-chat](05-detailed-design/11-research-chat.md) も) |
| `pipeline/app/research/graph/**`(グラフ・チェックポインタ・runner) | [05/10-research-agent](05-detailed-design/10-research-agent.md) §3.1 / §4.1.2 / §6.1 / §6.7 / §8.2 + [03-data-model](03-data-model.md)(checkpoint サブコレクション)+ [04-parameters](04-parameters.md) §2/§8.2.1 |
| `pipeline/app/utils/observability.py`(LangSmith) | [04-parameters](04-parameters.md) §2/§3 + [05/08-infra](05-detailed-design/08-infra.md) §6.2 + [runbook](../runbook.md) |
| `admin/**` | [05/07-admin-ui](05-detailed-design/07-admin-ui.md)(チャット画面は [05/11-research-chat](05-detailed-design/11-research-chat.md) も) |
