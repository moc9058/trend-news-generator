...
| [05-detailed-design/10-research-agent.md](05-detailed-design/10-research-agent.md) | 資料調査エージェント(Research Agent)+ short/article/report 移行(**状態: 設計・未実装**) | レポート生成機能の設計を確認したい/実装フェーズの指示に使う |
